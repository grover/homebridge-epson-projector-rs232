...
module.exports = {
  registerWith: function (hap) {
    ...
    // Bulb Luminance
    ////////////////////////////////////////////////////////////////////////////
    Characteristic.ProjectorBulbEcoMode = function () {
      Characteristic.call(this, 'Eco Mode', Characteristic.ProjectorBulbEcoMode.UUID);
      this.setProps({
        format: Characteristic.Formats.BOOL,
    ...
    Characteristic.ProjectorBulbEcoMode.UUID = '04E39455-7953-4800-A853-C2DE1B7FAE6A';
    inherits(Characteristic.ProjectorBulbEcoMode, Characteristic);
    ...
    Service.ProjectorBulbService = function (displayName, subtype) {
      ...
      this.addOptionalCharacteristic(Characteristic.ProjectorBulbEcoMode);
    };
